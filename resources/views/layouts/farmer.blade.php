...
<body class="m-0 overflow-hidden text-[#111827]">
    ...
    <div
        ...
        <aside
            ...
            <div class="flex items-center h-[80px] px-5 pt-4 pb-3 border-b border-gray-100">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="leading-tight">
                        ...
                        <p class="mt-1 text-[17px] text-white leading-none">
                            Marketplace
                        </p>
            ...
            <nav class="flex-1 px-5 py-6 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('farmer.dashboard') }}"
                    ...
                    {{ request()->routeIs('farmer.dashboard') ? 'text-[#1F7A1F] bg-white' : 'text-white hover:bg-green-50 hover:text-[#1F7A1F]' }}">
                ...
                <a href="{{ route('farmer.publishProducts') }}"
                    class="flex items-center gap-3 px-4 py-3 text-base font-semibold rounded-lg
                    {{ request()->routeIs('farmer.publishProducts') ? 'text-[#1F7A1F] bg-white' : 'text-white hover:bg-green-50 hover:text-[#1F7A1F]' }}">
                ...
                <a href="{{ route('farmer.products.myProducts') }}"
                    class="flex items-center gap-3 px-4 py-3 text-base font-semibold rounded-lg
                    {{ request()->routeIs('farmer.myProducts') ? 'text-[#1F7A1F] bg-white' : 'text-white hover:bg-green-50 hover:text-[#1F7A1F]' }}">
                ...
                <a href="{{ route('farmer.manageOffers') }}"
                    class="flex items-center gap-3 px-4 py-3 text-base font-semibold rounded-lg
                    {{ request()->routeIs('farmer.manageOffers') ? 'text-[#1F7A1F] bg-white' : 'text-white hover:bg-green-50 hover:text-[#1F7A1F]' }}">
                ...
                <a href="{{ route('farmer.confirmOrders') }}"
                    ...
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 14 3 8.5"/>

                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 14l9-5.5"/>
                    </svg>
                ...
                <a href="{{ route('farmer.demandAnalysis') }}"
                    ...
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 19V11"/>

                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 19V5"/>

                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 19V9"/>
                    </svg>
            ...
            <!-- Mobile Responsive: Promo card is hidden on very small screens -->
            <div class="hidden p-5 sm:block">
                ...
                <div class="p-4 bg-[#F0F9F1] rounded-xl">
                    ...
                    <p class="mt-2 text-base leading-5 text-gray-500">
                        Add more products and reach more buyers.
                    </p>
        ...
        <!-- Mobile Responsive: Removes sidebar margin on mobile -->
        <main class="min-h-screen ml-0 lg:ml-[240px]">

            <!-- Mobile Responsive: Smaller padding and gaps on mobile -->
            <header class="h-[80px] px-4 sm:px-6 lg:px-8 bg-white border-b border-gray-200 flex justify-between items-center gap-3">
                ...
                <!-- Mobile Responsive: Uses smaller gaps between topbar items -->
                <div class="flex items-center gap-1 sm:gap-3 lg:gap-4">
                    ...
                    <div
                        ...
                        <button
                            ...
                            <svg
                                class="hidden w-5 h-5 ml-2 text-black sm:block"
                                fill="none"
                                stroke="currentColor"
                                stroke-width="2.5"
                                viewBox="0 0 24 24">
